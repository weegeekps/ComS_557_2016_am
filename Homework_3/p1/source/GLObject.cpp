...
GLObject::GLObject()
{
    ...
    g_projectionMatrix = glm::perspective(1.1f, (float)800 / (float)600, 0.1f, 100.f);
    g_viewMatrix = glm::lookAt(glm::vec3(1.0f, 0.0f, 15.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    g_invViewMatrix = glm::inverse(g_viewMatrix);
